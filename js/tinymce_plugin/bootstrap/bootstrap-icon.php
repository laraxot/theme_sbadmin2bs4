        ...
        <div class="row margin-bottom-md">
            ...
            <div class="text-center">
                <div class="choice selector select-size margin-bottom-md">
                    <p><i
                            class="glyphicon <?php echo $glyphicon; ?>"></i>
                        extra-small</p>
                </div>
                <div class="choice selector select-size margin-bottom-md">
                    <h4><i
                ...
                <strong><?php echo CUSTOM; ?></strong> : <input
                    name="size-input" size="10" value=""> <strong>px</strong>
            </div>
        </div>
        <div class="row margin-bottom-md ">
            <div class="choice-title">
        ...
        $(document).ready(function() {
            ...
            if (!$('.selector.select-size').hasClass('active')) {
                $('input[name="size-input"]')
                    .val( <?php echo str_replace('px', '', $iconSize); ?> );
            }
            ...
            $('.selector.select-color').each(function(event, element) {
                ...
                $(element).find('span.color').attr('data-color', $(element).find('span.color').css(
                    'background-color')); // we catch background because it changes on hover
