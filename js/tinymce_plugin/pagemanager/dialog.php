...
<head>
    ...
    <script>
        var ext_img = new Array(
            '<?php echo implode("','", $ext_img); ?>'
        );
        var allowed_ext = new Array(
            '<?php echo implode("','", $ext); ?>'
        );
...
<body>
    ...
    <div class="uploader">
        ...
        <center><button class="btn btn-large btn-primary close-uploader"><i class="icon-backward icon-white"></i>
                <?php echo lang_Return_Files_List; ?></button>
        </center>
